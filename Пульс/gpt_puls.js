...
* В контексте нет чёткого ответа на вопрос
* Недостаточно данных для ответа
* Ты не можешь ответить по любой причине
...
function transferOperator(response) {
	...
	const redirectToOperator = `/switchredirect aiassist2 intent_id="article-f56520f8-6e24-4a02-93d2-0860ad6bb24f"`
