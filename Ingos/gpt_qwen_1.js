...
const REPHRASE_PROMPT_2 = `Ты — поисковый ассистент Инго Банка. 
...
* Учитывай синонимы, например: "дебетовая карта" / "карта счёта", "ингорубли" / "баллы" / "бонусы" / "Программа лояльности", "Цсписать" / "потратить" / "использовать", "аннулируются" / "сгорят"
